...
namespace RHI
{
    ...
    RHIDescriptorHandle DeviceD3D11::CreateRTVHeapDescriptorView(RHITexture* Texture)
    {
    ...
    RHIDescriptorHandle DeviceD3D11::CreateDSVHeapDescriptorView(RHITexture* Texture)
    {
